...
@dso_cache = dso_local local_unnamed_addr global [718 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1391270679, ; hash 0x52ed1b17, from name: Namada Maui
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1439480623, ; hash 0x55ccbb2f, from name: libaot-Namada Maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Namada Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 224
	...
	%struct.DSOCacheEntry {
		i64 1878917445, ; hash 0x6ffe0145, from name: aot-Namada Maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Namada Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 294
	...
	%struct.DSOCacheEntry {
		i64 2298557473, ; hash 0x89013421, from name: Namada Maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Namada Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 384
	...
	%struct.DSOCacheEntry {
		i64 2476947819, ; hash 0x93a3396b, from name: aot-Namada Maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Namada Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 414
	...
	%struct.DSOCacheEntry {
		i64 4238421775, ; hash 0xfca12f0f, from name: libaot-Namada Maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Namada Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 705
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [150 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
